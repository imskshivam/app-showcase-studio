...
const appCss = "/assets/styles-Cu-s5UXC.css";
...
async function trackEvent(name2, params) {
  const a = await initAnalytics();
  if (!a) return;
  logEvent(a, name2, params);
}
...
const $$splitComponentImporter$1 = () => import("./editor-BE2_jG_N.js");
const Route$1 = createFileRoute("/editor")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Design beautiful App Store and Play Store screenshots. iOS & Android frames, 3D depth, draggable text and images, instant PNG export."
    }, {
      name: "viewport",
...
const $$splitComponentImporter = () => import("./index-BLJqERBZ.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Markva is the modern studio for App Store & Play Store screenshots. Designed with AI-grade craft, exported in seconds."
    }, {
      name: "viewport",
      content: "width=device-width, initial-scale=1, viewport-fit=cover"
    }, {
      property: "og:title",
      content: "Markva — AI-crafted App Store screenshots"
    }, {
      property: "og:description",
      content: "Design beautiful screenshots with iOS & Android frames, 3D depth, kinetic text, and one-click export."
    }]
  })
});
const EditorRoute = Route$1.update({
  id: "/editor",
  path: "/editor",
